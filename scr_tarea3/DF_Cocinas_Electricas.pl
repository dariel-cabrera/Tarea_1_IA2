...
prop(3,'Potencia máxima sostenida superior a 2500w',p).
prop(4,'Consumo electrico superior a 2500kw/h',p).
prop(5,'Tarda más de 15 minutos en calentar',p).
prop(6,'Una sola hornilla encendida',p).
prop(7,'Dos hornillas encendidas',p).
prop(8,'Potencia máxima sostenida superior a 1500w',p).
prop(9,'Potencia máxima sostenida de la primera hornilla superior a 1500w',p).
...
main:-
    ...
    nl,writeln('Detectando Fallos en Cocinas Eléctricas teniendo en cuenta la Cantidad de Hornillas'),
    repeat,
    borrar_pesos,
